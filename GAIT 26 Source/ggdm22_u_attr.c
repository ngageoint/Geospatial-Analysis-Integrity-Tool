...
© 2017 Institute for Defense Analyses
  ...
  www.ida.org
************/
int GGDM22_U_ATTR_NUM=865;

char *GGDM22_U_attr_codes[] = {
"ZI020_GE4",
"ZI020_GE4A",
"ZI020_GE4B",
"ZI020_GE42",
...
char *GGDM22_U_attr_names[] = {
"(Location Country) Designation : GENC Short URN-based Identifier",
"(Location Country) Designation : GENC Short URN-based Identifier (first side)",
"(Location Country) Designation : GENC Short URN-based Identifier (second side)",
"(Location Country) Designation : GENC Short URN-based Identifier [2]",
"(Location Country) Designation : GENC Short URN-based Identifier [3]",
"(Location Country) Designation : GENC Short URN-based Identifier [4]",
...
"Administrative Division : BGN Administrative Level",
...
"Dataset (Table) : Unique Resource Identifier",
"Daymark Shape",
"Deck Count",
"Deck Level",
...
"Depth Curve or Contour Value : Sounding Metadata : Bathymetric Measurement Quality Category",
"Depth Curve or Contour Value : Sounding Metadata : Bathymetric Measurement Quality Category [2]",
"Depth Curve or Contour Value : Sounding Metadata : Bathymetric Measurement Quality Category [3]",
...
"Depth Curve or Contour Value : Sounding Metadata : Sounding Datum",
"Depth Curve or Contour Value : Sounding Metadata : Sounding Datum Name",
"Depth Curve or Contour Value : Sounding Metadata : Sounding Velocity Correction Method",
"Depth Curve or Contour Value : Sounding Metadata : Vessel Draft Correction",
...
"Entity Collection Metadata (Table) : Unique Entity Identifier",
"Equivalent Scale",
...
"Fault Type",
"Feature Attribute Metadata (Table) : Unique Entity Identifier",
"Feature Code",
"Feature Configuration",
"Feature Count",
"Feature Element Orientation",
"Feature Entity : Unique Entity Identifier",
"Feature Function",
"Feature Function [2]",
"Feature Function [3]",
"Feature Metadata (Table) : Unique Entity Identifier",
...
"Geopolitical Entity : Geographic Name Information (1) : Geographic Name Type (first side)",
...
"Geopolitical Entity : Geographic Name Information (2) : Geographic Name Type (second side)",
"Geopolitical Entity : Geographic Name Information (2) : Name Identifier (second side)",
"Geopolitical Entity Designation : FIPS 10-4 Country Name (first side)",
"Geopolitical Entity Designation : FIPS 10-4 Country Name (second side)",
"Geopolitical Entity Designation : ISO 3166-1 English Name",
...
"Water Resource Information : Water Use [4]",
"Water Resource Information : pH",
"Water Turbulence Type",
"Water Well Construction Description",
"Water Withdrawl Rate <interval closure>",
"Water Withdrawl Rate <lower value>",
"Water Withdrawl Rate <upper value>",
"Waterbody Depth",
...
"The angular distance in the horizontal plane measured from true north (0 degrees) clockwise to the major axis of the feature.   [Description] If the feature is square, the axis 0 up to 90 degrees is recorded. If the feature is circular, 360 degrees is recorded.Unit of Measure: arcDegree",
...
"The type(s) of permeable geologic formation that composes the aquifer.   [Description] The ability of the aquifer to store water is dependent on the porosity and permeability of the aquifer composition.",
"The type(s) of permeable geologic formation that composes the aquifer.   [Description] The ability of the aquifer to store water is dependent on the porosity and permeability of the aquifer composition.",
"The type(s) of permeable geologic formation that composes the aquifer.   [Description] The ability of the aquifer to store water is dependent on the porosity and permeability of the aquifer composition.",
...
"The type(s) and/or morphology(ies) of terrain material that overlie an aquifer.",
"The closure conditions of the two endpoints of a numeric interval.   [Description] Interval endpoint notation uses the parenthesis to specify that the endpoint is excluded from the interval (the continuous interval extends to, but does not include, the endpoint) and the square bracket to specify that the endpoint is included in the interval (the continuous interval extends to and includes the endpoint). For example, the unbounded interval [lowerValue, +infinity) where the lower endpoint is included and there is no upper endpoint.",
"The distance between the upper and lower surfaces of an aquifer.   [Description] The value describes the vertical extent of the completely saturated portion of the aquifer.Unit of Measure: metre",
"The distance between the upper and lower surfaces of an aquifer.   [Description] The value describes the vertical extent of the completely saturated portion of the aquifer.Unit of Measure: metre",
"The closure conditions of the two endpoints of a numeric interval.   [Description] Interval endpoint notation uses the parenthesis to specify that the endpoint is excluded from the interval (the continuous interval extends to, but does not include, the endpoint) and the square bracket to specify that the endpoint is included in the interval (the continuous interval extends to and includes the endpoint). For example, the unbounded interval [lowerValue, +infinity) where the lower endpoint is included and there is no upper endpoint.",
...
"The closure conditions of the two endpoints of a numeric interval.   [Description] Interval endpoint notation uses the parenthesis to specify that the endpoint is excluded from the interval (the continuous interval extends to, but does not include, the endpoint) and the square bracket to specify that the endpoint is included in the interval (the continuous interval extends to and includes the endpoint). For example, the unbounded interval [lowerValue, +infinity) where the lower endpoint is included and there is no upper endpoint.",
"The average water depth, exclusive of high water due to runoff or low water due to drought.   [Description] May be biased toward the maximum depths within the limits of the feature in order to support estimation of trafficability.Unit of Measure: Metre",
"The average water depth, exclusive of high water due to runoff or low water due to drought.   [Description] May be biased toward the maximum depths within the limits of the feature in order to support estimation of trafficability.Unit of Measure: Metre",
"The type of structure and/or material mounted on the top of a barrier (for example: a fence or a wall).",
"The vertical distance from a specified vertical datum to the terrain surface of or at the base of the feature.   [Description] If the feature is not supported above the surface by another feature then the base of the feature is usually located at ground or water level on the downhill/downstream side. For non-inland water bodies, the water level is usually understood to be Mean Sea Level (MSL). In the case of a survey marker (monument) this is usually the elevation assigned to the marker (monument).Unit of Measure: metre",
...
"The bearing of an object measured from a position at sea to the object (not from the object to somewhere at sea).Unit of Measure: Arc Degree",
"The bearing of an object from an observer (on any point along the line) towards the object or feature.   [Description] Expressed in degrees and tenths (for example: 3.0).Unit of Measure: Arc Degree",
...
"The type(s) of structural design of a bridge, bridge span, or bridge superstructure.",
"The type(s) of structural design of a bridge, bridge span, or bridge superstructure.",
"The transmission frequency of a radio communications device (for example: a television station or a radiobeacon).Unit of Measure: Hertz",
"The transmission frequency of a radio communications device (for example: a television station or a radiobeacon).Unit of Measure: Hertz",
...
"The quantity of product held per day.Unit of Measure: Cubic Litres",
"The centreline distance measured along the crest of a dam, and in the horizontal plane.Unit of Measure: Metres",
"The average distance across the crest of a dam.   [Description] The width is measured perpendicular to the crest centerline.Unit of Measure: Metre",
...
"The type(s) of material deliberately deposited in an area at sea.",
"The type(s) of material deliberately deposited in an area at sea.",
"The stabilized level of the water table in a well, measured with respect to the surface level and measured after a well has been pumped continuously for several hours.Unit of Measure: metre",
...
"The map scale that best represents the density of feature collection within the geospatial extent of a specified region, as a category.   [CodeListDefinition] An up to thirty-character lower camel-case alphanumeric code drawn from a codelist domain specified by the GEOINT Structure Implementation Profile (GSIP).   [Hyperlink] http://metadata.ces.mil/mdr/ns/GSIP/codelist/EquivalentScaleCategoryCode",
...
"A type of fracture in the earth's crust possibly resulting in the relative displacement and loss of continuity of the rocks on either side of it.",
"The globally unique and persistent identifier of an entity (for example: feature or event) instance as specified by a Uniform Resource Name (URN) in accordance with the Internet Engineering Task Force (IETF) RFC2396 and RFC2141.   [Description] It is based on the Uniform Resource Identifier (URI), a compact string of characters for identifying an abstract or physical resource. The term 'Uniform Resource Name' (URN) refers to the subset of URI that are required to remain globally unique and persistent even when the resource ceases to exist or becomes unavailable. The URN is drawn from one of a set of defined namespaces, each of which has its own set name structure and assignment procedures.   [DatatypeSpecification] A structured text value specifying a unique entity (for example: feature or event) identifier.   [EncodingSpecification] Structured in accordance with IETF RFC2396 and RFC2141; the namespace is managed by the NGA National Center for Geospatial Intelligence Standards (NCGIS).",
"Feature Code",
...
"The angular distance measured from true north (0 degrees) clockwise to the predominant linear pattern of the elements within a feature.Unit of Measure: Arc Degree",
"The globally unique and persistent identifier of an entity (for example: feature or event) instance as specified by a Uniform Resource Name (URN) in accordance with the Internet Engineering Task Force (IETF) RFC2396 and RFC2141.   [Description] It is based on the Uniform Resource Identifier (URI), a compact string of characters for identifying an abstract or physical resource. The term 'Uniform Resource Name' (URN) refers to the subset of URI that are required to remain globally unique and persistent even when the resource ceases to exist or becomes unavailable. The URN is drawn from one of a set of defined namespaces, each of which has its own set name structure and assignment procedures.   [DatatypeSpecification] A structured text value specifying a unique entity (for example: feature or event) identifier.   [EncodingSpecification] Structured in accordance with IETF RFC2396 and RFC2141; the namespace is managed by the NGA National Center for Geospatial Intelligence Standards (NCGIS).",
"The purpose(s) of, or intended role(s) served by, the feature.",
"The purpose(s) of, or intended role(s) served by, the feature.",
"The purpose(s) of, or intended role(s) served by, the feature.",
...
"The unique name identifier element in the NGA Geographic Names Data Base (GNDB).   [Description] Typically used together with Attribute: 'Named Feature Identifier' to provide a unique index into the NGA Geographic Names Data Base (GNDB) from which NGA draws all of its feature name information.",
"The unique name identifier element in the NGA Geographic Names Data Base (GNDB).   [Description] Typically used together with Attribute: 'Named Feature Identifier' to provide a unique index into the NGA Geographic Names Data Base (GNDB) from which NGA draws all of its feature name information.",
"The angle that a planar geologic surface is inclined from the horizontal.Unit of Measure: Degree of Arc",
"An indication that a geologic fault is visible at the ground surface.",
"The angle between a geologic strike line and true North.Unit of Measure: Degree of Arc",
...
"The type of a geographic name based on its scope of use, quality of source and/or its transliteration status.",
"The unique name identifier element in the NGA Geographic Names Data Base (GNDB).   [Description] Typically used together with Attribute: 'Named Feature Identifier' to provide a unique index into the NGA Geographic Names Data Base (GNDB) from which NGA draws all of its feature name information.",
"The Federal Information Processing Standards (FIPS) 10-4 full name that designates a geopolitical entity (for example: a State).   [Description] Often termed a 'country name'. Includes only the letters A through Z and punctuation marks.",
"The Federal Information Processing Standards (FIPS) 10-4 full name that designates a geopolitical entity (for example: a State).   [Description] Often termed a 'country name'. Includes only the letters A through Z and punctuation marks.",
...
"An overall assessment of an area's potential for successful well development based on the following factors: depth to aquifer, aquifer thickness, probable yields, aquifer material, overburden material, and water quality.",
...
"The height from a specified sounding datum to the bottom or base of a feature (for example: the base of a lighthouse).Unit of Measure: Metre",
"A general evaluation of the qualities of a bathymetric measurement, as a category.   [Description] Drying heights are typically captured using negative (bathymetric) sounding values; their certainty of measurement may be categorized in the same manner as positive values.",
"A general evaluation of the qualities of a bathymetric measurement, as a category.   [Description] Drying heights are typically captured using negative (bathymetric) sounding values; their certainty of measurement may be categorized in the same manner as positive values.",
"A general evaluation of the qualities of a bathymetric measurement, as a category.   [Description] Drying heights are typically captured using negative (bathymetric) sounding values; their certainty of measurement may be categorized in the same manner as positive values.",
"The technique used to determine water depth(s).",
...
"The method of correction that has been used to correct a sounding velocity instrument reading to obtain the correct depth.",
"An indication that a vessel draft correction has been applied.",
"The depth from a specified sounding datum to the top or surface of a feature (for example: the bottom of a water body).   [Description] Recorded depth values are usually positive, however in the case of drying heights they are negative.Unit of Measure: Metre",
"A general evaluation of the qualities of a bathymetric measurement, as a category.   [Description] Drying heights are typically captured using negative (bathymetric) sounding values; their certainty of measurement may be categorized in the same manner as positive values.",
"A general evaluation of the qualities of a bathymetric measurement, as a category.   [Description] Drying heights are typically captured using negative (bathymetric) sounding values; their certainty of measurement may be categorized in the same manner as positive values.",
"A general evaluation of the qualities of a bathymetric measurement, as a category.   [Description] Drying heights are typically captured using negative (bathymetric) sounding values; their certainty of measurement may be categorized in the same manner as positive values.",
"The technique used to determine water depth(s).",
...
"The method of correction that has been used to correct a sounding velocity instrument reading to obtain the correct depth.",
"An indication that a vessel draft correction has been applied.",
"The height of the feature, which tidal waters cover and uncover, referenced to a specified sounding datum.Unit of Measure: Metre",
...
"The horizontal angular width of a light sector to which the visibility of a light is limited.   [Description] The limits of light sectors (arcs of visibility) are arranged clockwise and are given from seaward toward the central object.Unit of Measure: Arc Degree",
"The initial angular limit of visibility of a light sector expressed as a bearing from seaward to the central object.   [Description] The order of sector initial limit and sector terminal limit is clockwise around the central object. The bearing direction conforms with the method used in 'List of Lights' publications.Unit of Measure: Arc Degree",
...
"The angular difference between True North and Magnetic North measured at a given position and date.   [Description] The value given indicates whether the angular difference is East (positive) or West (negative) of True North. True North is the direction of the northern point at which the geographic meridian lines meet.Unit of Measure: arcDegree",
"The closure conditions of the two endpoints of a numeric interval.   [Description] Interval endpoint notation uses the parenthesis to specify that the endpoint is excluded from the interval (the continuous interval extends to, but does not include, the endpoint) and the square bracket to specify that the endpoint is included in the interval (the continuous interval extends to and includes the endpoint). For example, the unbounded interval [lowerValue, +infinity) where the lower endpoint is included and there is no upper endpoint.",
"The difference between the magnetic variation within a magnetic disturbance area and the magnetic variation of the surrounding area.   [Description] It is measured east (positive value) or west (negative value) consistent with the directionality of the magnetic declination in general.Unit of Measure: Arc Degree",
"The difference between the magnetic variation within a magnetic disturbance area and the magnetic variation of the surrounding area.   [Description] It is measured east (positive value) or west (negative value) consistent with the directionality of the magnetic declination in general.Unit of Measure: Arc Degree",
...
"A set of two numbers for light ranges of visibility (at a light) expressed in nautical miles.   [Structure] The numbers are separated by a slash (/) if only two visibilities exist, or by a dash ('-') separating the greatest and least visibilities if three or more exist.",
"NAVAID facility radiated power.Unit of Measure: TBD",
...
"An indication that a feature may serve as a navigation landmark, allowing for rapid and positive orientation of a navigator.   [Description] Its size, shape, location, and/or isolation make it prominent in relation to its surroundings, and it is therefore easily recognized from the surface and/or from the air.",
...
"The conditions (for example: time or weather) during which the use of a feature (for example: a facility, an aerodrome, a port, or a thoroughfare) is restricted.",
"The conditions (for example: time or weather) during which the use of a feature (for example: a facility, an aerodrome, a port, or a thoroughfare) is restricted.",
"The least distance between the travelled way and any obstruction vertically above it.   [Description] Reference STANAG 2253.Unit of Measure: metre",
...
"The predominant height (the height of at least 50 percent) of the feature measured from the lowest point of the base at ground or water level (downhill side/downstream side).Unit of Measure: Metre",
"The predominant height (the height of at least 50 percent) of the feature measured from the lowest point of the base at ground or water level (downhill side/downstream side).Unit of Measure: Metre",
"The average (seasonal) high water depth, exclusive of high water due to runoff or low water due to drought.   [Description] May be biased toward the maximum depths within the limits of the feature in order to support estimation of trafficability.Unit of Measure: Metre",
...
"The average (seasonal) low water depth, exclusive of high water due to runoff or low water due to drought.   [Description] May be biased toward the maximum depths within the limits of the feature in order to support estimation of trafficability.Unit of Measure: Metre",
...
"The predominant water depth (the depth of at least 50 percent), determined along a bank-to-bank cross section.   [Description] Usually biased toward the maximum depths within the limits of the feature in order to support estimation of trafficability.Unit of Measure: metre",
"The closure conditions of the two endpoints of a numeric interval.   [Description] Interval endpoint notation uses the parenthesis to specify that the endpoint is excluded from the interval (the continuous interval extends to, but does not include, the endpoint) and the square bracket to specify that the endpoint is included in the interval (the continuous interval extends to and includes the endpoint). For example, the unbounded interval [lowerValue, +infinity) where the lower endpoint is included and there is no upper endpoint.",
"The predominant water depth (the depth of at least 50 percent), determined along a bank-to-bank cross section.   [Description] Usually biased toward the maximum depths within the limits of the feature in order to support estimation of trafficability.Unit of Measure: Metre",
"The predominant water depth (the depth of at least 50 percent), determined along a bank-to-bank cross section.   [Description] Usually biased toward the maximum depths within the limits of the feature in order to support estimation of trafficability.Unit of Measure: Metre",
"The primary range of the NAVAID beyond which the capture of the signal is not completely assured.Unit of Measure: Nautical Mile",
...
"The principal product(s) resulting from a production, mining, or agricultural activity.   [Description] If multiple products are specified then they are usually listed in descending order of importance.",
"The principal product(s) resulting from a production, mining, or agricultural activity.   [Description] If multiple products are specified then they are usually listed in descending order of importance.",
"The DFDD-compatible alphanumeric code-based accessor assigned to a model property.   [Description] The accessor may include multiple components that are composed using underscore-notation in the order that they are used to access the value of the property starting from a reference entity. The composed accessor may be used in physical implementations as a 'field name' to perform operations on the property value that is stored in that 'field' where the reference entity has been implemented as a 'table'. A DFDD-compatible code is a short, unique alphanumeric value that conforms to the DGIWG-developed Feature Data Dictionary (FDD) and may be used to designate a model property for the purposes of data interchange in conformance with DGIWG standards.   [DatatypeSpecification] A structured text value specifying a property DFDD accessor.   [EncodingSpecification] A text string whose content is structured in accordance with the requirements of the National System for Geospatial Intelligence Application Schema (NAS) - Part 1: Platform Independent Model (NGA.STND.0022).",
"The measurement from the well head to the top of the submersible pump located within the well borehole.Unit of Measure: metre",
...
"The official designation assigned to a route.   [Description] For example, 'I-95', 'A-1', 'E-6', or 'M-5'. The route designation may continue along ferry crossing or ice routes in order to provide continuity with the transportation network.",
"The official designation assigned to a route.   [Description] For example, 'I-95', 'A-1', 'E-6', or 'M-5'. The route designation may continue along ferry crossing or ice routes in order to provide continuity with the transportation network.",
"The official designation assigned to a route.   [Description] For example, 'I-95', 'A-1', 'E-6', or 'M-5'. The route designation may continue along ferry crossing or ice routes in order to provide continuity with the transportation network.",
...
"The total usable width of the travelled way of a route.   [Description] Includes pavements and shoulders.Unit of Measure: metre",
...
"The Controlled Access Program Coordination Office (CAPCO) authorized abbreviations for sensitive compartmented information control system(s) applicable to the resource.   [DatatypeSpecification] A structured text consisting of a sequence of values that are individually drawn from a codelist, each domain member of which denotes an SCI control that is applicable to a resource.   [EncodingSpecification] A character string consisting of an ordered list of space-separated codelist values. The codelist domain is specified by the (US) Intelligence Community implementation profile for information security markings.   [Hyperlink] http://metadata.ces.mil/mdr/ns/GSIP/schema/ic/ism/7.0.0/CVEnumISMSCIControls",
"One or more indicators identifying information controlled under the U.S. Atomic Energy Act.   [DatatypeSpecification] A structured text consisting of a sequence of values that are individually drawn from a codelist, each domain member of which denotes an atomic energy marking that is applicable to a resource.   [EncodingSpecification] A character string consisting of an ordered list of space-separated codelist values. The codelist domain is specified by the (US) Intelligence Community implementation profile for information security markings.   [Hyperlink] http://metadata.ces.mil/mdr/ns/GSIP/schema/ic/ism/7.0.0/CVEnumISMAtomicEnergyMarkings",
...
"The reason that a portion or resource is marked with a higher and/or more restrictive mark than its components would indicate.   [Description] For example, this would document why 3 Unclassified bullet items form a Secret List. Without this reason being noted, such a document would be considered to be mismarked and over-classified.",
"The year, month and day of publication or release of a resource source, or the most recent resource source, that was itself marked with a declassification constraint.   [Description] It is no longer valid as of the release of ISM Version 7 and its use has been deprecated.   [DatatypeSpecification] A structured text value specifying a resource date of exempted source.   [EncodingSpecification] Formatted in accordance with ISO 8601:2000, a calendar date representation, as a single data element comprising ten characters, where [YYYY] represents a calendar year, [MM] the ordinal number of a calendar month within the calendar year, and [DD] the ordinal number of a day within the calendar month, where the three components are separated by the hyphen '-' character (for example: '1985-04-12').",
...
"The physical characteristics of a shoreline.",
"The actual path length divided by the shortest path length of a section of the road or trail allowing for estimates of speed given the curves of the roadway. [Description] This allows for routing algorithms to more precisely estimate the speed.Unit of Measure: Metres",
"The closure conditions of the two endpoints of a numeric interval.   [Description] Interval endpoint notation uses the parenthesis to specify that the endpoint is excluded from the interval (the continuous interval extends to, but does not include, the endpoint) and the square bracket to specify that the endpoint is included in the interval (the continuous interval extends to and includes the endpoint). For example, the unbounded interval [lowerValue, +infinity) where the lower endpoint is included and there is no upper endpoint.",
...
"The depth of the snow or ice.   [Description] The snow or ice  layer ranges from the top of the snow or ice surface to the underlying terrain.Unit of Measure: Metre",
"The closure conditions of the two endpoints of a numeric interval.   [Description] Interval endpoint notation uses the parenthesis to specify that the endpoint is excluded from the interval (the continuous interval extends to, but does not include, the endpoint) and the square bracket to specify that the endpoint is included in the interval (the continuous interval extends to and includes the endpoint). For example, the unbounded interval [lowerValue, +infinity) where the lower endpoint is included and there is no upper endpoint.",
"The depth of the soil or unconsolidated surface material.   [Description] The soil layer ranges from the top of the organic horizon 'O' to the bottom of the substratum 'C'.Unit of Measure: metre",
"The depth of the soil or unconsolidated surface material.   [Description] The soil layer ranges from the top of the organic horizon 'O' to the bottom of the substratum 'C'.Unit of Measure: metre",
...
"A description of the data set that was used to define the digital representation of the feature or data set.   [Description] No restriction is placed on the length of the description.",
"The type(s) of the data set(s) that were used to define the digital representation of the feature or data set.   [Description] For example, based on a data product specification.   [CodeListDefinition] An up to thirty-character lower camel-case alphanumeric code drawn from a codelist domain specified by the GEOINT Structure Implementation Profile (GSIP).   [Hyperlink] http://metadata.ces.mil/mdr/ns/GSIP/codelist/SourceTypeCode",
...
"The type of an electricity distribution substation based on its function(s).",
"The type of an electricity distribution substation based on its function(s).",
"The fraction of canopy cover within a defined area during the summer season.   [Description] The canopy is formed by the upper branches of the trees in a forest forming a more or less continuous layer.Unit of Measure: Percent",
...
"The type(s) of material that compose the surface layer of the terrain.",
"The type(s) of material that compose the surface layer of the terrain.",
"The distance between the two opposite surfaces of an object, usually the distance of smallest measure.   [Description] The third dimension of an object, distinct from length and width (breadth).Unit of Measure: metre",
"An indication that a ground transportation route (for example: road, cart track or trail) is the most direct way through (both into and then out of) a built-up area or populated place.   [Description] Routes may branch off of the main through route providing an alternate through route out of the built-up area or populated place. The direct or alternate ways through a built-up area or populated place may consist of the quickest or shortest route. A through route may have devices (for example: traffic lights) to control traffic flow.",
"The tidal current direction at the time of the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level.Unit of Measure: Arc Degree",
"The tidal current direction 1 hour after the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Arc Degree",
"The tidal current direction 1 hour before the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Arc Degree",
"The tidal current direction 2 hours after the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Arc Degree",
"The tidal current direction 2 hours before the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Arc Degree",
"The tidal current direction 3 hours after the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Arc Degree",
"The tidal current direction 3 hours before the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Arc Degree",
"The tidal current direction 4 hours after the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Arc Degree",
"The tidal current direction 4 hours before the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Arc Degree",
"The tidal current direction 5 hours after the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Arc Degree",
"The tidal current direction 5 hours before the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Arc Degree",
"The tidal current direction 6 hours after the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Arc Degree",
"The tidal current speed at the time of the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level.Unit of Measure: Knot",
"The tidal current speed 1 hour after the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Knot",
"The tidal current speed 1 hour before the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Knot",
"The tidal current speed 2 hours after the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Knot",
"The tidal current speed 2 hours before the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Knot",
"The tidal current speed 3 hours after the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Knot",
"The tidal current speed 3 hours before the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Knot",
"The tidal current speed 4 hours after the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Knot",
"The tidal current speed 4 hours before the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Knot",
"The tidal current speed 5 hours after the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Knot",
"The tidal current speed 5 hours before the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Knot",
"The tidal current speed 6 hours after the tide reference level.   [Description] Typically used together with Attribute: 'Reference Water Level' to specify the tide reference level from which the time offset is specified.Unit of Measure: Knot",
...
"The fraction of land within a defined area that is covered by undergrowth (for example: scrub, brush, and/or bush).Unit of Measure: percent",
"The delineation quality of an underwater feature that is derived from overhead imagery (for example; airborne or satellite remote sensing imagery), as a category.   [Description] Water column characteristics and other environmental factors (for example: water surface roughness or sun glint) will degrade the accuracy of the delineated extent of features.",
"The globally unique and persistent identifier of an entity (for example: feature or event) instance as specified by a Uniform Resource Name (URN) in accordance with the Internet Engineering Task Force (IETF) RFC2396 and RFC2141.   [Description] It is based on the Uniform Resource Identifier (URI), a compact string of characters for identifying an abstract or physical resource. The term 'Uniform Resource Name' (URN) refers to the subset of URI that are required to remain globally unique and persistent even when the resource ceases to exist or becomes unavailable. The URN is drawn from one of a set of defined namespaces, each of which has its own set name structure and assignment procedures.   [DatatypeSpecification] A structured text value specifying a unique entity (for example: feature or event) identifier.   [EncodingSpecification] Structured in accordance with IETF RFC2396 and RFC2141; the namespace is managed by the NGA National Center for Geospatial Intelligence Standards (NCGIS).",
"The globally unique and persistent identifier of a resource (for example: a dataset or a service) instance as specified by a Uniform Resource Identifier (URI) in accordance with the Internet Engineering Task Force (IETF) RFC2396.   [DatatypeSpecification] A structured text value specifying a unique resource (for example: dataset or service) identifier.   [EncodingSpecification] Structured in accordance with IETF RFC2396 (URI Generic Syntax); the namespace is managed by the NGA National Center for Geospatial Intelligence Standards (NCGIS).",
"The interior length of a structure (for example: an aircraft bunker or a lock).   [Description] The length is taken along the primary alignment of the structure. If the structure is irregular in shape the length is along its greatest horizontal dimension, else if the structure is regular in shape then a shape-specific rule may apply: for a rectangular structure, the length of the longer axis; for a round structure, the diameter.Unit of Measure: metre",
"The interior width of a structure.   [Description] For example, an aircraft bunker or a lock.Unit of Measure: metre",
...
"The volume of a feature.   [Description] For example, the storage capacity of a water tower.Unit of Measure: cubicMetre",
...
"The mass of magnesium per volume of solution.   [Description] Elevated concentrations of magnesium are typically associated with 'hard' water.Unit of Measure: Milligrams per Litre",
"The cloudiness or haziness of a volume of solution as determined by its degree of light scattering.   [Description] Turbidity is caused by suspended solids that are generally invisible to the naked eye, for example: suspended clay, silt, organic and inorganic matter, and plankton and other microorganisms. The units of turbidity from a calibrated nephelometer (based on the scattering of a focused beam of light) are called Nephelometric Turbidity Units (NTU).Unit of Measure: Nephelometric Turbidity Units",
...
"The mass of sulfate ions per volume of solution.Unit of Measure: Milligrams per Litre",
"The thermal energy (heat) of a substance.   [Description] The quantity of internal energy that a substance contains.Unit of Measure: Degree Celsius",
"The total mass of dissolved inorganic chemical constituents per volume of solution.Unit of Measure: Milligrams per Litre",
"The electrical conductivity of water.   [Description] Electrical conductivity is the ease with which an electric current flows through a conductor per unit length.Unit of Measure: MicroSiemens per Centime",
"The rate of water flow through or exiting from a feature.Unit of Measure: Litres per Minute",
...
"The fraction of canopy cover within a defined area during the winter season.   [Description] The canopy is formed by the upper branches of the trees in a forest forming a more or less continuous layer.Unit of Measure: Percent",
"The transmission frequency of a radio communications device (for example: a television station or a radiobeacon).Unit of Measure: TBD",
