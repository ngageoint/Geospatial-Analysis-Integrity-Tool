...
************/
#include "share.h"
int GGDM22_U_CLASS_NUM=405;

char *GGDM22_U_class_codes[] = {
"FA000",
"FA003",
"AB040",
"AT011",
...
"A device that is used for emitting and/or sensing electromagnetic energy.   [Description] For example, used to transmit and/or receive electronic signals as on a radio tower or to capture electromagnetic energy as in radio astronomy.",
...
"A beacon used to indicate the location of an aerodrome from the air.   [Description] Aerodrome beacons may consist of either a rotating light source or a strobe light.",
...
"A heavy object, kept in place on the seafloor by its weight and possibly with flukes, to which is attached a cable, rope, or chain that keeps a buoy on the waterbody surface positioned within a narrow region.",
"An area of relatively uniform water depth with no cables, pipelines, or hazardous obstructions present on the seafloor in which vessels anchor or may anchor.   [Description] Anchorage areas are additionally determined by: the depth of water in comparison to the tidal range; the material of the seafloor bottom; local environmental effects of wind and currents; and proximity to hazards to navigation, adjacent ships, and harbor traffic lanes. Although the anchorage refers to an identified area along the water surface, its physical structure is considered to be the material and condition of the seafloor below. An anchorage can be physically damaged by natural events (for example: an earthquake or tsunami) by which the preferred seafloor bottom type can change, or hazardous obstructions can be created or moved into the anchorage area.",
...
"A pipe or artificial channel that is designed to transport water from a remote source, usually by gravity, for freshwater supply, agricultural, and/or industrial use.   [Description] It may be supported by a bridge.",
...
"The location at which vessels are required to report to a traffic control center.   [Description] Note that this is not the same as an aeronautical waypoint, which is for aircraft only.",
...
"A tract covered mainly by large treelike grasses.   [Description] For example, bamboo and sugarcane.",
...
"A resource that is a set of instances of one or more modeling entities selected according to a single rationale (for example: a common production or publication process).   [Description] For example, a set of modeling entities whose instances together constitute a 'water resources map'.",
...
"A concave-shaped aerial that is used for emitting and/or sensing electromagnetic energy.   [Description] For example, used to transmit and/or receive electronic signals as at a satellite station or to capture electromagnetic energy as in radio astronomy.",
...
"Upward-pointing obstacles laid in the ground to slow or stop the movement of vehicles.   [Description] Typically constructed of regularly spaced concrete or metal shapes laid in single or multiple rows.",
...
"An excavation and/or embankment created by remolding the natural configuration of the terrain for the purpose of enhancing the defense of a site from armed attack.   [Description] The earthwork may include ancillary elements (for example: a palisade) or reinforcements (for example: a concrete facing).",
...
"A modeling entity collecting metadata (for example: source, lineage, quality) about the digital representation of a feature attribute.   [Description] For example, the currency of the information known about a feature attribute or the degree to which the attribute value is accurately and/or completely determined. Feature attributes are characteristics of features, which are representations of temporally persistent real-world phenomena.",
"A modeling entity collecting metadata (for example: source, lineage, quality) about the digital representation of a feature and its properties (attributes and associations).   [Description] For example, the currency of the information known about a feature or the degree to which the properties of a feature are accurately and/or completely determined. Features are representations of temporally persistent real-world phenomena, including their geometric position and extent.",
...
"An artificial structure or gate that is utilized as a defense against flooding or storm surges.   [Description] Consideration should be given to using the more specific Dam or Embankment features where appropriate in lieu of Flood Control Structure.",
...
"A tract covered mainly by grasses that have little or no woody tissue.   [Description] For example, pasture, meadow, and steppe.",
...
"The line of demarcation specifying the operational limits of a functional area controlled by a recognized authority.   [Description] The geographic limThe geographic limits of the installation boundary may include both land and water currently owned or used by the recognized controlling installation or facility. Typically, the installation boundary will enclose a grouping of facilities, located in the same general vicinity, which support functions particular to the needs and requirements of the installation property. The controlling installation or facility may have been constructed to support military operations.its of the installation boundary may include both land and water currently owned or used by the recognized controlling installation or facility. Typically, the installation boundary will enclose a grouping of facilities, located in the same general vicinity, which support functions particular to the needs and requirements of the installation property. The controlling installation or facility may have been constructed to support military operations.",
...
"A luminous or lighted device intended for the purpose of aiding maritime navigation.   [Description] A Maritime Navigation Light refers to the light itself including its housing but does not include any support structure or ancillary aids to maritime navigation.",
...
"A facility utilizing radar to detect and analyze objects (for example: aircraft, artificial satellites, asteroids, and/or missiles) and/or environmental phenomena (for example: tornadoes).   [Description] May include both a radar aerial as well as a structure housing radar equipment.",
...
"A modeling entity that relates an information resource to metadata regarding that resource.   [Description] An information resource is a set of instances of one or more modeling entities selected according to a single rationale (for example: a common production or publication process, a common theme or spatial region). Modeling entities may, for example, represent data series, datasets, entity collections, features, and/or events, including their characteristics and interrelationships.",
...
"A device used to raise ships vertically between water bodies with different elevations.   [Description] Normally ship elevators consist of water filled chambers which can be raised or lowered by means of mechanical devices. Commonly used to move ships between canals where locks would be impractical.",
...
"A lamp intended to illuminate a road.   [Description] May also illuminate the ground adjacent to the road. Usually attached to a tall pole.",
...
"A balloon that is tethered to the ground at an anchoring device (for example: a ring and pad) or substantial structure (for example: a mooring tower).   [Description] It is usually deployed for extended periods of time and may be used, for example, for weather sensing and/or observation of the surrounding terrain.",
...
"The location in a tidally influenced stream where observations are taken.   [Description] Tidal stream observation stations are either anchored in place or attached to a buoy.",
...
"A set of automatic lights (usually red, amber, and green) for controlling road traffic, especially at a road intersection.   [Description] Usually attached to tall poles or suspended from overhead cables.",
...
"A removable cover or plate which provides access to underground utility tunnels, distribution lines, or drainage systems.   [Description] For example, a manhole cover.",
...
"An area where heaped material (for example: waste or spoil) is deposited.   [Description] Waste heaps may be located at disposal sites or in unsanctioned and unprepared locations where illegal dumping takes place. Illegal dumping sites are usually composed of materials produced in the immediately surrounding area; for example, in a residential neighborhood their content would principally be household trash. Illegal dumping sites have no associated structures or facilities.",
...
D_OCEN  /*** Reef ***/,
D_DAQU  /*** Resource Metadata Relation ***/,
...
int GGDM22_UDOMAINSLEN = sizeof(GGDM22_UDOMAINS)/ sizeof(unsigned char);

unsigned char GGDM22_USTRATS[]={
0  /*** Dummy Value ***/,
...
S_APPL  /*** Reef ***/,
S_APPL  /*** Resource Metadata Relation ***/,
...
int GGDM22_USTRATSLEN = sizeof(GGDM22_USTRATS)/ sizeof(unsigned char);
