...
************/
#include "share.h"
int GGDM21_CLASS_NUM=385;

char *GGDM21_class_codes[] = {
"FA000",
"FA003",
"AB040",
"AT011",
...
"A tract covered mainly by short, uncultured, woody plants.   [Description] For example, covered by brush, scrub and/or shrubs. The predominant height is usually less than 2-3 metres.",
...
"A terrain object (for example: a marker) with a known location (for example: horizontal position, elevation, or both) intended to serve as a survey control.   [Description] Usually of a lower order of positional accuracy than a Geodetic Point but of sufficient accuracy for local surveying.",
...
"Land and water currently owned or used by the military installation or facility.",
...
"A tract of land that is legally defined in location and extent.   [Description] Improvements (for example: buildings, fences, and wells) to the tract of land are distinct from the land itself and thus may have different associated rights and/or restrictions than those of the underlying tract of land.",
...
"A station that serves as a stopping place along a transportation route.   [Description] For example, used for the transfer of passengers and/or freight.",
...
"An area where heaped material (for example: waste or spoil) is deposited. [Description] This is typically human trash piles and may be found anywhere, it is not a transfer station or established site, nor is it always associated with a facility.",
...
"A structure that uses a water wheel or turbine to drive a mechanical process (for example: grinding grain into flour, cutting timber into lumber, or stripping bark from trees for use in tanning).   [Description] A watermill that only generates electricity is more usually termed a 'hydroelectric plant'.",
...
"A building and associated equipment that is used to inspect and weigh motor vehicles.   [Description] Located adjacent to a road and used to enforce a variety of motor vehicle safety regulations. Motor vehicles may be weighed by driving them onto a platform.",
...
int GGDM21DOMAINSLEN = sizeof(GGDM21DOMAINS)/ sizeof(unsigned char);

unsigned char GGDM21STRATS[]={
0  /*** Dummy Value ***/,
...
int GGDM21STRATSLEN = sizeof(GGDM21STRATS)/ sizeof(unsigned char);
